...
function UserDetail() {
   ...
   return (
      <div className='w-full flex justify-start items-center min-h-screen flex-col '>
         ...
         <section className=' bg-gray-100  bg-opacity-50 w-[90%] rounded-lg my-5'>
            <form onSubmit={handleSubmit(onHandleSubmit)} className='mx-auto  max-w-4xl md:w-3/4 shadow-md'>
